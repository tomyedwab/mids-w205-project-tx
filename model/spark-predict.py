...
weather_joined_df = (weather_normalized_df
    ...
    .select(
        ...
        weather_normalized_df.date,
        weather_normalized_df.time,
        weather_normalized_df.temperature,
        weather_normalized_df.humidity,
        weather_normalized_df.pressure,
        weather_normalized_df.visibility,
        weather_normalized_df.precipIntensity,
        weather_normalized_df.windSpeed,
